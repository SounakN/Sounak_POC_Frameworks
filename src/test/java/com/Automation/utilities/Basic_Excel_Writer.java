...
public class Basic_Excel_Writer {
    ...
    public static void Excel_Writer_New_Excel_Google_SEO_Crawling_Specifics(String filename, String sheetname, HashMap<Integer, ArrayList<String>> values) {
        try
        {
            ...
            ConditionalFormattingRule rule1 = sheetCF.createConditionalFormattingRule(ComparisonOperator.EQUAL, "Passed");
            ConditionalFormattingRule rule2 = sheetCF.createConditionalFormattingRule(ComparisonOperator.EQUAL, "Failed");
            ConditionalFormattingRule rule3 = sheetCF.createConditionalFormattingRule(ComparisonOperator.EQUAL, "CAPTCHA Validation came UP");
            ...
            CellRangeAddress[] regions = {CellRangeAddress.valueOf("D1:D3")};
