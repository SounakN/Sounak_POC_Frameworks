...
public class sellPhoneActions {
    ...
    By availableDate = By.xpath("//div[text()='Please select your preferable pickup date']/following-sibling::div[2]/div");
    ...
    By continueAddress = By.xpath("//div[text()='Address']/ancestor::div[@class='web-view flwidth mar-b20']/following-sibling::div//div[text()='Continue']");
    By pickUpSlotsContinue = By.xpath("//div[text()='Pickup Slot']/ancestor::div[@class='web-view flwidth mar-b20']/following-sibling::div//div[text()='Continue']");
    //Payment SLots
    By Upi = By.xpath("//div[text()='Select your payment mode']/following-sibling::div[2]//input");
    By confirmOrderButton = By.xpath("//div[text()='Confirm Order']/ancestor::button");
    By confirmationMessage = By.xpath("//*[text()='Your order has been confirmed']");
    ...
    public boolean pickUpInformation(String day, String slot, String paymentType, String furtherActivity) {
        try {
            ...
            ActionMethods.JavaScriptClick(driver,ActionMethods.FindElement(continueAddress, driver, 10, 2));
            ...
            ActionMethods.JavaScriptClick(driver,ActionMethods.FindElement(pickUpSlotsContinue, driver, 10, 2));
            ActionMethods.EmbedText(SetUp.Sc, "Selected Pick Up Slots");
            ...
            ActionMethods.JavaScriptClick(driver,ActionMethods.FindElement(confirmOrderButton,driver,20,5));
            ActionMethods.FindElement(confirmationMessage,driver,20,5);
