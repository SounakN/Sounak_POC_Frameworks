...
public class sellPhoneStepDefinitions {
    ...
    public void userChecksAllThoseAvailableOptionsForThePhone() {
        try{
            ...
            sellPhoneActions.chooseAvailableAccessories("Tell us more about your device's screen defects");
            sellPhoneActions.chooseAvailableAccessories("Tell us more about your device's body defects");
            sellPhoneActions.chooseAvailableAccessories("Tell us more about your device's body defects");
