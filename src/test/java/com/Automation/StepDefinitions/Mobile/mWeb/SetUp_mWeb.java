package com.Automation.StepDefinitions.Mobile.mWeb;
...
public class SetUp_mWeb {
    ...
    public void setupTest(Scenario scenario) throws Exception {
        ...
        //Getting the browser
        String Driver=(System.getProperty("Driver_mobile")!=null)?System.getProperty("Driver_mobile"): data.getProperty("Driver_mobile");
